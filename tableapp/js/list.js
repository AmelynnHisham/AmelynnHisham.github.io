...
function GetBooking() {
    let url = 'https://api.sheety.co/9bc9fa53e8c14a58cab4639f8eb627c2/bookingApp/bookings';
    fetch(url)
        ...
        .then(json => {
            ...
            for(let i = 0; i < json.bookings.length; i++) {
                ...
                // grab the row then add the table
...
function DeleteBooking(id) {
    let url = 'https://api.sheety.co/9bc9fa53e8c14a58cab4639f8eb627c2/bookingApp/bookings/' + id;
    fetch(url, {
        method: 'DELETE',
    })
    .then(() => {
